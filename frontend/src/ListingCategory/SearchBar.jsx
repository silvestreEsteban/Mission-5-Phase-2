  ...
  return (
    <div className={styles.searchBody}>
      ...
      <div className={styles.SearchBar}>
        ...
        >
          <path
            d="M8.672 15.535L15.6905 8.46497M8.672 8.46497L15.6905 15.535"
            stroke="#76716D"
            stroke-width="1.5"
      ...
      <div className={styles.buttonOuter}>
        <button className={styles.button1}>
          ...
          >
            <path
              d="M11.6665 4.58337H6.4165M8.1665 10.4167H2.9165"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
            ...
            />
            <path
              d="M9.9165 12.1667C10.883 12.1667 11.6665 11.3832 11.6665 10.4167C11.6665 9.45025 10.883 8.66675 9.9165 8.66675C8.95001 8.66675 8.1665 9.45025 8.1665 10.4167C8.1665 11.3832 8.95001 12.1667 9.9165 12.1667Z"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
            />
            <path
              d="M4.08325 6.33337C5.04975 6.33337 5.83325 5.54987 5.83325 4.58337C5.83325 3.61688 5.04975 2.83337 4.08325 2.83337C3.11675 2.83337 2.33325 3.61688 2.33325 4.58337C2.33325 5.54987 3.11675 6.33337 4.08325 6.33337Z"
              stroke="white"
              stroke-width="2"
              stroke-linecap="round"
              stroke-linejoin="round"
          ...
          >
            <g clip-path="url(#clip0_955_938)">
              <path
                d="M8.75009 2.16663L1.25009 2.16663C1.17415 2.16682 1.09972 2.18358 1.0348 2.21509C0.969888 2.24661 0.916944 2.29169 0.881671 2.34548C0.8464 2.39928 0.830134 2.45975 0.834627 2.52039C0.83912 2.58103 0.864201 2.63955 0.90717 2.68963L4.65717 7.02297C4.81259 7.20263 5.18675 7.20263 5.34259 7.02297L9.09259 2.68963C9.13599 2.63965 9.16145 2.58111 9.16618 2.52037C9.17092 2.45962 9.15476 2.39901 9.11946 2.3451C9.08415 2.29119 9.03105 2.24605 8.96593 2.21458C8.90081 2.18312 8.82616 2.16654 8.75009 2.16663Z"
                fill="white"
              />
            </g>
            <defs>
              <clipPath id="clip0_955_938">
                <rect
                  ...
                  height="8"
                  fill="white"
                  transform="translate(10 8.5) rotate(180)"
                />
              </clipPath>
            </defs>
          </svg>
