          ...
          {listings.map((listing) => (
            <div key={listing._id} className={myStyles.listing}>
              <div className={myStyles.ImageSpace}>
                {/* had svg here to overlay - not working - added in svgLinks file for later  */}
              ...
              <div className={myStyles.Details}>
                <div className={myStyles.info}>
                  ...
                  <p className={myStyles.bidPrice}>Current Bid:</p>{" "}
                  <h2>$ {listing.price}</h2> {/* {startingPrice} maybe? */}
              ...
              <div className={myStyles.OuterDesc}>
                ...
                <div className={myStyles.shipAndPay}>
                  <div className={myStyles.shipping}>
                    <svg
                      width="35"
                      height="20"
                      viewBox="0 0 60 42"
                  ...
                  <p className={myStyles.pickUp}>
                    ...
                    Pick up available {listing.location}</p>
                  
                  <p className={myStyles.payment}>
                    <svg
                      width="40"
                      height="30"
                      viewBox="0 0 36 20"
