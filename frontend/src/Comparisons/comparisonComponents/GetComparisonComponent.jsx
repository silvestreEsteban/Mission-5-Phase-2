        ...
        <div className={myStyles.ExtraPageContainer}>
          {listings.map((listing) => (
            <div key={listing._id} className={myStyles.listing}>
              <div className={myStyles.ImageSpace}><div className={myStyles.ImageSpaceButton}><button><strong>View Listing</strong></button></div><div className={myStyles.WatchListIcon}><svg width="89" height="89" viewBox="0 0 89 89" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className={myStyles.Scroll2}><img src="weui_arrow-outlined2.jpg"  /></div><img src={listing.image} alt={listing.title} />
              </div>
              ...
              <div className={myStyles.OuterDesc}>
                ...
                <div className={myStyles.Remove}> <button> <strong>x</strong>  </button><p>remove</p> </div><div className={myStyles.ImageSpaceButton2}><button><strong>View Listing</strong></button></div>
