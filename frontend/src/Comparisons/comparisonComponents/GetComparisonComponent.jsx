        ...
        <div className={myStyles.ExtraPageContainer}>
          {listings.map((listing) => (
            <div key={listing._id} className={myStyles.listing}>
              <div className={myStyles.ImageSpace}><div className={myStyles.WatchListIcon}><svg width="89" height="89" viewBox="0 0 89 89" fill="none" xmlns="http://www.w3.org/2000/svg">
