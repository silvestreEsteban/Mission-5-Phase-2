      ...
      <div className={myStyles.ExtraPageContainer}>
        {listings.map((listing) => (
          <div key={listing._id} className={myStyles.EmptyListing}>
            ...
            <div className={myStyles.ImageSpaceButton}><button><strong>View Listing</strong></button></div>
...
<div className={myStyles.Scroll2}><img src="weui_arrow-outlined2.jpg"  /></div>
        ...
        <div className={myStyles.ImageSpaceButton2}><button><strong>View Listing</strong></button></div>
    </>
  );
};
