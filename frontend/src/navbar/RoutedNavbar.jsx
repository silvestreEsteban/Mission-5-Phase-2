        ...
        <div className={styles.BottomContainerRight}>
          ...
          <Link to="/comparissonPage">
            <p>
              ...
              >
                <path
                  d="M8.06797 13.9056C11.4703 13.9056 14.2285 11.1522 14.2285 7.75585C14.2285 4.35945 11.4703 1.60612 8.06797 1.60612C4.66562 1.60612 1.90747 4.35945 1.90747 7.75585C1.90747 11.1522 4.66562 13.9056 8.06797 13.9056Z"
                  fill="#595959"
                  stroke="#595959"
                  strokeWidth="2"
                  strokeLinecap="round"
          ...
          <Link to="/start-listing">
            <p>
              ...
              >
                ...
                />
                <path
                  d="M27.8125 9.8125L34.1875 16.1875"
                  stroke="#76716D"
                  strokeWidth="5"
                />
              </svg>
          ...
          <Link to="/notifications">
            <p>
              ...
              >
                <path
                  d="M45.5 41.1667V43.3333H6.5V41.1667L10.8333 36.8333V23.8333C10.8333 17.1167 15.2317 11.2017 21.6667 9.29501V8.66668C21.6667 7.51741 22.1232 6.41521 22.9359 5.60255C23.7485 4.78989 24.8507 4.33334 26 4.33334C27.1493 4.33334 28.2515 4.78989 29.0641 5.60255C29.8768 6.41521 30.3333 7.51741 30.3333 8.66668V9.29501C36.7683 11.2017 41.1667 17.1167 41.1667 23.8333V36.8333L45.5 41.1667ZM30.3333 45.5C30.3333 46.6493 29.8768 47.7515 29.0641 48.5641C28.2515 49.3768 27.1493 49.8333 26 49.8333C24.8507 49.8333 23.7485 49.3768 22.9359 48.5641C22.1232 47.7515 21.6667 46.6493 21.6667 45.5"
                  fill="#76716D"
                />{" "}
              </svg>
              Notifications
            ...
            <p>
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M30.6668 16.375C30.6668 18.5409 29.8064 20.6181 28.2749 22.1497C26.7433 23.6812 24.6661 24.5416 22.5002 24.5416C20.3342 24.5416 18.257 23.6812 16.7255 22.1497C15.1939 20.6181 14.3335 18.5409 14.3335 16.375C14.3335 14.209 15.1939 12.1318 16.7255 10.6003C18.257 9.06873 20.3342 8.20831 22.5002 8.20831C24.6661 8.20831 26.7433 9.06873 28.2749 10.6003C29.8064 12.1318 30.6668 14.209 30.6668 16.375ZM26.5835 16.375C26.5835 17.4579 26.1533 18.4966 25.3875 19.2623C24.6217 20.0281 23.5831 20.4583 22.5002 20.4583C21.4172 20.4583 20.3786 20.0281 19.6128 19.2623C18.847 18.4966 18.4168 17.4579 18.4168 16.375C18.4168 15.292 18.847 14.2534 19.6128 13.4876C20.3786 12.7219 21.4172 12.2916 22.5002 12.2916C23.5831 12.2916 24.6217 12.7219 25.3875 13.4876C26.1533 14.2534 26.5835 15.292 26.5835 16.375Z"
                  fill="#76716D"
                />
               
              </svg>
            </p>
            <span id={styles.DropdownIcon}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="40"
